...
export default function ProjectsGrid() {
	...
	return (
		<div className="grow md:flex space-y-8 md:space-y-0 md:space-x-8 pt-12 md:pt-16 pb-16 md:pb-20 mt-12 md:mt-16 border-t border-slate-800">

			<div className="grow">

				<div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
					<h2 className="h2 font-cabinet-grotesk text-slate-100">Some <span className="bg-gradient-to-r from-green-300 via-sky-500 to-purple-500 bg-[length:100%_4px] bg-no-repeat bg-bottom">stuff</span> that I&apos;ve made</h2>
				</div>
				...
				<div className="space-y-10 relative">
					...
					<div className="flex justify-center items-center absolute bottom-0 w-full h-48 bg-gradient-to-t from-slate-900 pointer-events-none">
						<div>
							<Link className="btn inline-flex items-center text-slate-200 bg-sky-500 hover:bg-sky-600 group pointer-events-auto" href="/projects">
								See All Projects
