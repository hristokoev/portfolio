		...
		<div className="grow md:flex space-y-8 md:space-y-0 md:space-x-8 pt-12 md:pt-16 pb-16 md:pb-20 mt-12 md:mt-16 border-t border-slate-200 dark:border-slate-800">
			...
			<div className="grow">
				...
				<div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
					<h2 className="h2 font-cabinet-grotesk dark:text-slate-100">Some <span className="dark:bg-gradient-to-r from-green-300 via-sky-500 to-purple-500 bg-[length:100%_4px] bg-no-repeat bg-bottom">stuff</span> that I&apos;ve made</h2>
				</div>
				...
				<div className="space-y-10 relative">
					...
					<div className="flex justify-center items-center absolute bottom-0 w-full h-48 bg-gradient-to-t from-white dark:from-slate-900 pointer-events-none">
						<div>
							<Link className="btn inline-flex items-center text-slate-200 bg-slate-800 hover:bg-slate-700 dark:bg-sky-500 dark:hover:bg-sky-600 group pointer-events-auto" href="/projects">
								See All Projects
								<span className="tracking-normal text-sky-500 dark:text-white group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-2">
